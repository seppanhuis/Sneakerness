...
('Sneakerness Rotterdam 2025', '2025-11-08', 'Rotterdam Ahoy', 100, 120, 'Weekend editie'),
('Sneakerness Amsterdam 2025', '2025-05-10', 'RAI Amsterdam', 80, 90, 'Spring edition'),
('Sneakerness Utrecht 2024', '2024-09-12', 'Jaarbeurs', 100, 75, 'Local event'),
('Sneakerness Antwerp 2023', '2023-10-05', 'Antwerp Expo', 60, 50, 'International'),
('Sneakerness Berlin 2022', '2022-06-20', 'Station Berlin', 70, 40, 'Historic');

-- Organisatoren
INSERT INTO Organisator (Naam, Gebruikersnaam, Wachtwoord, Opmerking) VALUES
('Sander de Vries', 'sander', '{HASHED_PW}', 'Lead organisator'),
('Marieke Janssen', 'marieke', '{HASHED_PW}', 'Ticketing en sales'),
('Tom Peters', 'tom', '{HASHED_PW}', 'Logistiek'),
('Anna de Boer', 'anna', '{HASHED_PW}', 'PR & marketing'),
('K. van Dijk', 'kdijk', '{HASHED_PW}', 'Finance');

-- Bezoekers
INSERT INTO Bezoeker (Naam, Emailadres, Opmerking) VALUES
('Jeroen Bak', 'jeroen.bak@example.com', 'VIP'),
('Sofia Kuiper', 'sofia.kuiper@example.com', 'Loyalty'),
('Lars van der Meer', 'lars.meer@example.com', NULL),
('Emma Visser', 'emma.visser@example.com', NULL),
('Ali Rafiq', 'ali.rafiq@example.com', 'First time');

-- Prijzen
INSERT INTO Prijs (EvenementId, Datum, Tijdslot, Tarief, Opmerking) VALUES
(1, '2025-11-08', '11:00-12:00', 12.50, 'Early bird'),
(1, '2025-11-08', '12:00-13:00', 15.00, NULL),
(1, '2025-11-08', '14:00-15:00', 20.00, 'Peak'),
(2, '2025-05-10', '11:00-12:00', 10.00, NULL),
(2, '2025-05-10', '12:00-13:00', 14.00, 'Afternoon');

-- Tickets
INSERT INTO Ticket (BezoekerId, EvenementId, PrijsId, AantalTickets, Datum, Opmerking) VALUES
(1, 1, 1, 2, '2025-11-08', 'Klant vroeg aangemeld'),
(2, 1, 3, 1, '2025-11-08', NULL),
(3, 2, 4, 3, '2025-05-10', 'Groep'),
(4, 2, 5, 1, '2025-05-10', NULL),
(5, 1, 2, 1, '2025-11-08', 'Promocode gebruikt');

-- Verkopers
INSERT INTO Verkoper (Naam, SpecialeStatus, VerkooptSoort, StandType, Dagen, Logo, Opmerking) VALUES
('SneakerShop NL', 1, 'Vintage Sneakers', 'AA+', '2', '/logos/sneakershop.png', 'Partner'),
('StreetFood Co', 0, 'Eten & Drinken', 'A', '1', NULL, NULL),
('KidsCorner', 0, 'Kids Toys', 'A', '1', NULL, NULL),
('RetroKicks', 0, 'Secondhand', 'AA', '2', NULL, 'Reservelijst'),
('UrbanWear', 1, 'Kleding', 'AA+', '2', '/logos/urbanwear.png', 'Sponsor');

-- Stands
INSERT INTO Stand (VerkoperId, StandType, Prijs, VerhuurdStatus, Opmerking) VALUES
(1, 'AA+', 500.00, TRUE, 'Hoog profiel stand'),
(2, 'A', 150.00, FALSE, NULL),
(3, 'A', 120.00, TRUE, 'Kids area'),
(4, 'AA', 300.00, FALSE, 'Back-up'),
(5, 'AA+', 700.00, TRUE, 'Premium partner');

-- Contactpersonen
INSERT INTO Contactpersoon (Naam, Telefoonnummer, Emailadres, Opmerking) VALUES
('Peter de Jong', '+31 6 12345678', 'peter.jong@example.com', 'Stand/contact voor SneakerShop'),
('Laila Ahmed', '+31 6 87654321', 'laila.ahmed@example.com', 'StreetFood contact'),
('Tom van Leeuwen', '+31 6 11223344', 'tom.leeuwen@example.com', NULL),
('Sanne Koster', '+31 6 44332211', 'sanne.koster@example.com', NULL),
('Rick Vermeulen', '+31 6 55443322', 'rick.vermeulen@example.com', 'Logistiek'),
-- ✅ Twee ongekoppelde contactpersonen:
...
(3, 3, NULL),
(4, 4, 'Reservering stand'),
(5, 5, 'Sponsorship contact');
