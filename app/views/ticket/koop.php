...
<div class="container mt-3">
    ...
    <div class="alert alert-success" style="display:<?= $data['message']; ?>;">Ticket succesvol gekocht!</div>

    <form method="POST" action="<?= URLROOT; ?>/ticket/koop">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="number" name="AantalTickets" min="1" value="1" class="form-control" required>
        </div>
